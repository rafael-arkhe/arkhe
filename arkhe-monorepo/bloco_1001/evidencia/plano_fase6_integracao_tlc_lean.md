...
Módulo novos (`src/lean/FieldStabilityTLCSpec.lean`), sem Mathlib, sem `sorry`,
espelhando `ArkheCoherenceLedger.tla`:
...
2. `lake build` (núcleo Lean I511–I523 + `FieldStabilityTLCSpec`).
...
1. `src/lean/FieldStabilityTLCSpec.lean` + I517–I523: kernel Lean 4 v4.33.1,
